...
public class ProductUpdateRequest {
    ...
    @Valid // This ensures that the validation rules on ProductVariantUpdateRequest are triggered
    private List<ProductVariantUpdateRequest> variants;

    // Additional fields for updates
    private String attributes; // JSON string for additional product attributes
